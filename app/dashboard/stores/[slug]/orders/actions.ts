...
import { withErrorParam, withQuery } from "@/lib/url";
...
export async function advanceOrderStatus(
  ...
  const defaultListUrl = withQuery(`/dashboard/stores/${slug}/orders`, returnQs);
  ...
  if (error) {
    redirect(withErrorParam(`/dashboard/stores/${slug}/orders`, error.message));
  }
...
export async function markOrderPaid(
  ...
  const listUrl = withQuery(`/dashboard/stores/${slug}/orders`, returnQs);
