...
function resolveLayout(raw: unknown): StoreTheme["layout"] {
  ...
  return {
    ...
    heroTaglineAlign: pickLayoutChoice("heroTaglineAlign", l.heroTaglineAlign),
    heroTaglineWeight: pickLayoutChoice("heroTaglineWeight", l.heroTaglineWeight),
    heroTaglineTracking: pickLayoutChoice("heroTaglineTracking", l.heroTaglineTracking),
    heroTaglineLeading: pickLayoutChoice("heroTaglineLeading", l.heroTaglineLeading),
    heroEyebrowFontScale: clampOr(l.heroEyebrowFontScale, clampHeroFontScale, 1.0),
    heroEyebrowTracking: pickLayoutChoice("heroEyebrowTracking", l.heroEyebrowTracking),
    heroEyebrowColor: normalizeHexColor(l.heroEyebrowColor),
    heroEyebrowCase: pickLayoutChoice("heroEyebrowCase", l.heroEyebrowCase),
    heroEyebrowWeight: pickLayoutChoice("heroEyebrowWeight", l.heroEyebrowWeight),
    heroEyebrowLeading: pickLayoutChoice("heroEyebrowLeading", l.heroEyebrowLeading),
    ...
    heroSubtitleWeight: pickLayoutChoice("heroSubtitleWeight", l.heroSubtitleWeight),
    heroSubtitleTracking: pickLayoutChoice("heroSubtitleTracking", l.heroSubtitleTracking),
    heroSubtitleLeading: pickLayoutChoice("heroSubtitleLeading", l.heroSubtitleLeading),
    heroCtaFontScale: clampOr(l.heroCtaFontScale, clampHeroFontScale, 1.0),
    heroCtaTracking: pickLayoutChoice("heroCtaTracking", l.heroCtaTracking),
    ...
    heroBylineTracking: pickLayoutChoice("heroBylineTracking", l.heroBylineTracking),
    heroBylineCase: pickLayoutChoice("heroBylineCase", l.heroBylineCase),
    heroBylineWeight: pickLayoutChoice("heroBylineWeight", l.heroBylineWeight),
    heroBylineLeading: pickLayoutChoice("heroBylineLeading", l.heroBylineLeading),
    ...
    heroImageFocusX: pickLayoutChoice("heroImageFocusX", l.heroImageFocusX),
    ...
    heroSplitTextAlignX: pickLayoutChoice("heroSplitTextAlignX", l.heroSplitTextAlignX),
    ...
    heroMinimalAlign: pickLayoutChoice("heroMinimalAlign", l.heroMinimalAlign),
    ...
    heroTextAlignX: pickLayoutChoice("heroTextAlignX", l.heroTextAlignX),
