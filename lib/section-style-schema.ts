...
export const SECTION_STYLE_ENUMS = {
  ...
  // 一圈細框那一檔才有東西可調（面板那檔畫的是底色，沒有線可以加粗）。上面幾格把卡片的
  ...
  // 條件——設成一圈細框那一檔才有意義。上一格解的是線有多粗，這格解的是線有多明顯，兩件
  ...
  // 條件——設成一圈細框那一檔才有意義。前兩格解的是那條線有多粗、有多明顯，這一格解的是
  ...
  // ——只有卡片外觀設成「一塊底色面板」那一檔才有意義（一圈細框那檔畫的是線，沒有底可以
